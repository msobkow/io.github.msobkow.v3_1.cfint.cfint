// Description: Java 25 implementation of a MimeType by UNameIdx index key buffer
...
public class CFIntBuffMimeTypeByUNameIdxKey
	implements ICFIntMimeTypeByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFIntBuffMimeTypeByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
