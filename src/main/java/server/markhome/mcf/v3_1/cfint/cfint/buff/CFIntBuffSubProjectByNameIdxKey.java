// Description: Java 25 implementation of a SubProject by NameIdx index key buffer
...
public class CFIntBuffSubProjectByNameIdxKey
	implements ICFIntSubProjectByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFIntBuffSubProjectByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
