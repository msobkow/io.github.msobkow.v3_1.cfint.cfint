...
public class CFIntSecRoleEnablesObj
	implements ICFIntSecRoleEnablesObj
{
	...
	public CFIntSecRoleEnablesObj() {
		isNew = true;
		requiredContainerRole = null;
		requiredParentEnableGroup = null;
	}

	public CFIntSecRoleEnablesObj( ICFSecSchemaObj argSchema ) {
		schema = argSchema;
		isNew = true;
		edit = null;
		requiredContainerRole = null;
	...
	public ICFSecSecRoleEnablesObj realise() {
		ICFSecSecRoleEnablesObj retobj = ((ICFIntSchemaObj)getSchema()).getSecRoleEnablesTableObj().realiseSecRoleEnables(
	...
	@Override
	public void forget() {
		((ICFIntSchemaObj)getSchema()).getSecRoleEnablesTableObj().reallyDeepDisposeSecRoleEnables( (ICFSecSecRoleEnablesObj)this );
	}

	@Override
	public ICFSecSecRoleEnablesObj read() {
		ICFSecSecRoleEnablesObj retobj = ((ICFIntSchemaObj)getSchema()).getSecRoleEnablesTableObj().readSecRoleEnablesByIdIdx( getPKey().getRequiredSecRoleId(),
	...
	public ICFSecSecRoleEnablesTableObj getSecRoleEnablesTable() {
		return( ((ICFIntSchemaObj)getSchema()).getSecRoleEnablesTableObj() );
	}
	...
	public ICFSecSecRoleEnables getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableSecRoleEnables().readDerivedByIdIdx( ((ICFIntSchemaObj)getSchema()).getAuthorization(),
	...
	public ICFSecSecRoleEnablesEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFIntSchemaObj)getSchema()).getSecRoleEnablesTableObj().lockSecRoleEnables( getPKey() );
		}
		edit = ((ICFIntSchemaObj)getSchema()).getSecRoleEnablesTableObj().newEditInstance( lockobj );
	...
	public ICFSecSecRoleObj getRequiredContainerRole( boolean forceRead ) {
		if( ( requiredContainerRole == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				requiredContainerRole = ((ICFIntSchemaObj)getSchema()).getSecRoleTableObj().readSecRoleByIdIdx( getPKey().getRequiredSecRoleId(), forceRead );
			}
		}
