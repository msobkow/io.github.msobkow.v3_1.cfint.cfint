// Description: Java 25 implementation of a MajorVersion by TenantIdx index key buffer
...
public class CFIntBuffMajorVersionByTenantIdxKey
	implements ICFIntMajorVersionByTenantIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFIntBuffMajorVersionByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
