...
public class CFIntSecTentGrpIncTableObj
	implements ICFIntSecTentGrpIncTableObj
{
	...
	public CFIntSecTentGrpIncTableObj() {
		schema = null;
	...
	public CFIntSecTentGrpIncTableObj( ICFSecSchemaObj argSchema ) {
	 ...
	 *	CFIntSecTentGrpIncObj.
	 */
	@Override
	public ICFSecSecTentGrpIncObj newInstance() {
		ICFSecSecTentGrpIncObj inst = new CFIntSecTentGrpIncObj( schema );
		return( inst );
	}
	...
	public ICFSecSecTentGrpIncEditObj newEditInstance( ICFSecSecTentGrpIncObj orig ) {
		ICFSecSecTentGrpIncEditObj edit = new CFIntSecTentGrpIncEditObj( orig );
		return( edit );
	}
	...
	{
		final String S_ProcName = "CFIntSecTentGrpIncTableObj.reallyDeepDisposeSecTentGrpInc() ";
		String classCode;
		if( obj == null ) {
			return;
		}
