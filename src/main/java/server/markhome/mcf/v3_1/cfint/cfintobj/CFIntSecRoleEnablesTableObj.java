...
public class CFIntSecRoleEnablesTableObj
	implements ICFIntSecRoleEnablesTableObj
{
	...
	public CFIntSecRoleEnablesTableObj() {
		schema = null;
	...
	public CFIntSecRoleEnablesTableObj( ICFSecSchemaObj argSchema ) {
	 ...
	 *	CFIntSecRoleEnablesObj.
	 */
	@Override
	public ICFSecSecRoleEnablesObj newInstance() {
		ICFSecSecRoleEnablesObj inst = new CFIntSecRoleEnablesObj( schema );
		return( inst );
	}
	...
	public ICFSecSecRoleEnablesEditObj newEditInstance( ICFSecSecRoleEnablesObj orig ) {
		ICFSecSecRoleEnablesEditObj edit = new CFIntSecRoleEnablesEditObj( orig );
		return( edit );
	}
	...
	{
		final String S_ProcName = "CFIntSecRoleEnablesTableObj.reallyDeepDisposeSecRoleEnables() ";
		String classCode;
		if( obj == null ) {
			return;
		}
