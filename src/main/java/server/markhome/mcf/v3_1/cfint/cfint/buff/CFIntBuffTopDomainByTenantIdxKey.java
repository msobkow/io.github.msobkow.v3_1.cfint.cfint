// Description: Java 25 implementation of a TopDomain by TenantIdx index key buffer
...
public class CFIntBuffTopDomainByTenantIdxKey
	implements ICFIntTopDomainByTenantIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFIntBuffTopDomainByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
