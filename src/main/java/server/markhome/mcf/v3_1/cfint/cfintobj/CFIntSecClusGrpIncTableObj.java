...
public class CFIntSecClusGrpIncTableObj
	implements ICFIntSecClusGrpIncTableObj
{
	...
	public CFIntSecClusGrpIncTableObj() {
		schema = null;
	...
	public CFIntSecClusGrpIncTableObj( ICFSecSchemaObj argSchema ) {
	 ...
	 *	CFIntSecClusGrpIncObj.
	 */
	@Override
	public ICFSecSecClusGrpIncObj newInstance() {
		ICFSecSecClusGrpIncObj inst = new CFIntSecClusGrpIncObj( schema );
		return( inst );
	}
	...
	public ICFSecSecClusGrpIncEditObj newEditInstance( ICFSecSecClusGrpIncObj orig ) {
		ICFSecSecClusGrpIncEditObj edit = new CFIntSecClusGrpIncEditObj( orig );
		return( edit );
	}
	...
	{
		final String S_ProcName = "CFIntSecClusGrpIncTableObj.reallyDeepDisposeSecClusGrpInc() ";
		String classCode;
		if( obj == null ) {
			return;
		}
