...
// Description: Java 25 Factory service implementation for MajorVersion buffers
...
/*
 *	Java 25 Factory service implementation for MajorVersion buffers.
 */
@Service("cfint31BuffMajorVersionFactoryService")
public class CFIntBuffMajorVersionFactoryService
	implements ICFIntMajorVersionFactory
{
	public CFIntBuffMajorVersionFactoryService() {
	}
