// Description: Java 25 implementation of a MinorVersion history buffer object
...
public class CFIntBuffMinorVersionH
    implements ICFIntMinorVersionH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFIntMinorVersionHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFIntBuffMinorVersionHPKey) {
                this.pkey = (CFIntBuffMinorVersionHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFIntBuffMinorVersionHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFIntBuffMinorVersionH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
