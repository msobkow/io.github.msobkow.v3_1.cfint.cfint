// Description: Java 25 implementation of a MajorVersion by SubProjectIdx index key buffer
...
public class CFIntBuffMajorVersionBySubProjectIdxKey
	implements ICFIntMajorVersionBySubProjectIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFIntBuffMajorVersionBySubProjectIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
