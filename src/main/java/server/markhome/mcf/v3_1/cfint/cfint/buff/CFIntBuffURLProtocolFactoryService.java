...
// Description: Java 25 Factory service implementation for URLProtocol buffers
...
/*
 *	Java 25 Factory service implementation for URLProtocol buffers.
 */
@Service("cfint31BuffURLProtocolFactoryService")
public class CFIntBuffURLProtocolFactoryService
	implements ICFIntURLProtocolFactory
{
	public CFIntBuffURLProtocolFactoryService() {
	}
