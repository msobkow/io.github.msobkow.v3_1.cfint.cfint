// Description: Java 25 implementation of a URLProtocol history buffer primary key
...
/**
 *	CFIntBuffURLProtocolHPKey History Primary Key for URLProtocol
	...
	implements ICFIntURLProtocolHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFIntBuffURLProtocolHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
