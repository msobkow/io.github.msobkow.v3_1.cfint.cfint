...
public class CFIntSecRoleMembTableObj
	implements ICFIntSecRoleMembTableObj
{
	...
	public CFIntSecRoleMembTableObj() {
		schema = null;
	...
	public CFIntSecRoleMembTableObj( ICFSecSchemaObj argSchema ) {
	...
	public ICFSecSecRoleMembObj newInstance() {
		ICFSecSecRoleMembObj inst = new CFIntSecRoleMembObj( schema );
		return( inst );
	}
	...
	public ICFSecSecRoleMembEditObj newEditInstance( ICFSecSecRoleMembObj orig ) {
		ICFSecSecRoleMembEditObj edit = new CFIntSecRoleMembEditObj( orig );
		return( edit );
	}
	...
	{
		final String S_ProcName = "CFIntSecRoleMembTableObj.reallyDeepDisposeSecRoleMemb() ";
		String classCode;
		if( obj == null ) {
			return;
		}
