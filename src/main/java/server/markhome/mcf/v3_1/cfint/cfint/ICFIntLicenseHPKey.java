// Description: Java 25 interface for a License history primary key object
...
/**
 *	ICFIntLicenseHPKey History Primary Key interface for License has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredId	Required object attribute Id. */
public interface ICFIntLicenseHPKey
{
