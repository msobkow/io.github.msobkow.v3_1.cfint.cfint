	...
	extends ICFSecSecUserObj
{
	...
	/**
	 *	Get the optional ICFIntSecUserPasswordObj instance referenced by the Password key.
	 *
	 *	@return	The optional ICFIntSecUserPasswordObj instance referenced by the Password key.
	 */
	...
	/**
	 *	Get the optional ICFIntSecUserEMConfObj instance referenced by the EMConf key.
	 *
	 *	@return	The optional ICFIntSecUserEMConfObj instance referenced by the EMConf key.
	 */
	...
	/**
	 *	Get the optional ICFIntSecUserPWResetObj instance referenced by the PWReset key.
	 *
	 *	@return	The optional ICFIntSecUserPWResetObj instance referenced by the PWReset key.
	 */
	...
	/**
	 *	Get the optional ICFIntSecUserPWHistoryObj instance referenced by the PWHistory key.
	 *
	 *	@return	The optional ICFIntSecUserPWHistoryObj instance referenced by the PWHistory key.
	 */
