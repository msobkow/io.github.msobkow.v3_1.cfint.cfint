	...
	implements ICFIntSecClusGrpTableObj
{
	...
	private Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj> members;
	private Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj> allSecClusGrp;
	private Map< ICFSecSecClusGrpByClusterIdxKey,
		Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj > > indexByClusterIdx;
	private Map< ICFSecSecClusGrpByNameIdxKey,
		Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj > > indexByNameIdx;
	...
	public CFIntSecClusGrpTableObj() {
		schema = null;
		members = new HashMap<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj>();
		allSecClusGrp = null;
	...
	public ICFSecSecClusGrpObj realiseSecClusGrp( ICFSecSecClusGrpObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByClusterIdx != null ) {
				...
				Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj > mapClusterIdx = indexByClusterIdx.get( keyClusterIdx );
			...
			if( indexByNameIdx != null ) {
				...
				Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj > mapNameIdx = indexByNameIdx.get( keyNameIdx );
				if( mapNameIdx != null ) {
	...
	@Override
	public ICFSecSecClusGrpObj readSecClusGrp( $iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$ pkey ) {
		return( readSecClusGrp( pkey, false ) );
	}

	@Override
	public ICFSecSecClusGrpObj readSecClusGrp( $iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFSecSecClusGrpObj readCachedSecClusGrp( $iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$ pkey ) {
		ICFSecSecClusGrpObj obj = null;
	...
	@Override
	public void deepDisposeSecClusGrp( $iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$ pkey ) {
	...
	@Override
	public ICFSecSecClusGrpObj lockSecClusGrp( $iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$ pkey ) {
	...
	public List<ICFSecSecClusGrpObj> readAllSecClusGrp( boolean forceRead ) {
		...
		if( ( allSecClusGrp == null ) || forceRead ) {
			Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj> map = new HashMap<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$,ICFSecSecClusGrpObj>();
			allSecClusGrp = map;
		...
		boolean forceRead )
	{
		...
		Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj> dict;
		if( indexByClusterIdx == null ) {
			indexByClusterIdx = new HashMap< ICFSecSecClusGrpByClusterIdxKey,
				Map< $iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj > >();
		}
		if( ( ! forceRead ) && indexByClusterIdx.containsKey( key ) ) {
			dict = indexByClusterIdx.get( key );
		}
		else {
			dict = new HashMap<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj>();
			ICFSecSecClusGrpObj obj;
	...
	public void deleteSecClusGrpByClusterIdx( $implIJavaAtomType$ ClusterId )
	{
		...
		if( indexByClusterIdx.containsKey( key ) ) {
			Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj> dict = indexByClusterIdx.get( key );
	...
	public void deleteSecClusGrpByNameIdx( $implIJavaAtomType$ Name )
	{
		...
		if( indexByNameIdx.containsKey( key ) ) {
			Map<$iterate Columns ( lone implIJavaOptAtomType first implIJavaOptAtomType each implCommaIJavaOptAtomType empty empty )$, ICFSecSecClusGrpObj> dict = indexByNameIdx.get( key );
