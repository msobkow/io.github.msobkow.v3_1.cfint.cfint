...
// Description: Java 25 Factory service implementation for TopDomain buffers
...
/*
 *	Java 25 Factory service implementation for TopDomain buffers.
 */
@Service("cfint31BuffTopDomainFactoryService")
public class CFIntBuffTopDomainFactoryService
	implements ICFIntTopDomainFactory
{
	public CFIntBuffTopDomainFactoryService() {
	}
