// Description: Java 25 Instance Edit Object interface for CFInt SecClusRole.
...
public interface ICFIntSecClusRoleEditObj
	extends ICFIntSecClusRoleObj, ICFSecSecClusRoleEditObj
{
	/*
