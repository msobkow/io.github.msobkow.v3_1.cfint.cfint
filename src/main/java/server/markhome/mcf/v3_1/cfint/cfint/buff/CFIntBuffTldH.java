// Description: Java 25 implementation of a Tld history buffer object
    ...
    implements ICFIntTldH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFIntTldHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFIntBuffTldHPKey) {
                this.pkey = (CFIntBuffTldHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFIntBuffTldHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFIntBuffTldH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
