// Description: Java 25 implementation of a TopProject history buffer object
...
public class CFIntBuffTopProjectH
    implements ICFIntTopProjectH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFIntTopProjectHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFIntBuffTopProjectHPKey) {
                this.pkey = (CFIntBuffTopProjectHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFIntBuffTopProjectHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFIntBuffTopProjectH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
