// Description: Java 25 implementation of a SubProject history buffer object
...
public class CFIntBuffSubProjectH
    implements ICFIntSubProjectH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFIntSubProjectHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFIntBuffSubProjectHPKey) {
                this.pkey = (CFIntBuffSubProjectHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFIntBuffSubProjectHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFIntBuffSubProjectH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
