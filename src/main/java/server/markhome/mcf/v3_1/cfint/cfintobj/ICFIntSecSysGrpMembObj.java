// Description: Java 25 Object interface for CFInt SecSysGrpMemb.
...
public interface ICFIntSecSysGrpMembObj
	extends ICFSecSecSysGrpMembObj
{
	...
	/**
	 *	Get the required ICFIntSecSysGrpObj instance referenced by the Group key.
	 *
	 *	@return	The required ICFIntSecSysGrpObj instance referenced by the Group key.
	 */
