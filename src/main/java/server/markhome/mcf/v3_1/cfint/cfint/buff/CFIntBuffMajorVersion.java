	...
	implements ICFIntMajorVersion, Comparable<Object>, Serializable
{
	...
	public void setRequiredContainerParentSPrj(CFLibDbKeyHash256 argSubProjectId) {
		ICFIntSubProject found = getRequiredContainerParentSPrj(argSubProjectId);
		if (found == null || (found != null && ((!found instanceof ICFIntSubProject) && (!found instanceof ICFIntProtSubProject) && (!found instanceof ICFIntPubSubProject))) {
		setRequiredSubProjectId(argSubProjectId);
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentSPrj-args", "ICFIntSubProjectICFIntProtSubProjectICFIntPubSubProject", found);
		}
	}
