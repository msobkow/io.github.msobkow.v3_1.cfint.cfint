// Description: Java 25 implementation of a MajorVersion buffer
...
public class CFIntBuffMajorVersion
	implements ICFIntMajorVersion, Comparable<Object>, Serializable
{
	...
	public ICFIntSubProject getRequiredContainerParentSPrj() {
		...
		ICFIntSubProject targetRec = targetTable.readDerivedByIdIdx(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredSubProjectId());
		return(targetRec);
	}
	...
	public void setRequiredContainerParentSPrj(CFLibDbKeyHash256 argSubProjectId) {
		...
		ICFIntSubProject found = targetTable.readDerivedByIdIdx(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argSubProjectId);
		if (found == null) {
	...
	public void setRequiredContainerParentSPrj(ICFIntSubProject argObj) {
		if(argObj == null) {
			...
			setRequiredSubProjectId(argObj.getRequiredId());
		}
	}
	...
	public void setRequiredContainerParentSPrj(CFLibDbKeyHash256 argSubProjectId) {
		...
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerParentSPrj-args", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubSubProjectTable targetTable = targetBackingCFInt.getTableSubProject();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerParentSPrj", 0, "ICFIntPubSchema.getBackingCFInt().getTableSubProject()");
		}
		ICFIntPubSubProject found = targetTable.readDerivedByIdIdx(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argSubProjectId);
		if (found == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerParentSPrj-args", 0, "found");
		}
		else if ((found instanceof ICFIntSubProject) || (found instanceof ICFIntProtSubProject) || (found instanceof ICFIntPubSubProject)) {
	...
	public String toString() {
		String ret = "<CFIntBuffMajorVersion" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
