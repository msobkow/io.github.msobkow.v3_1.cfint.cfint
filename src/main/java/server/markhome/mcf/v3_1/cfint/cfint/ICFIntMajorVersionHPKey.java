...
/**
 *	ICFIntMajorVersionHPKey History Primary Key interface for MajorVersion has CodeVis Public, meaning that any user interface or referencing schema can access it.
