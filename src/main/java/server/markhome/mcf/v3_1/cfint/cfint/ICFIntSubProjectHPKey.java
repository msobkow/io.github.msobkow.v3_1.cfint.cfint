...
/**
 *	ICFIntSubProjectHPKey History Primary Key interface for SubProject has CodeVis Public, meaning that any user interface or referencing schema can access it.
