// Description: Java 25 implementation of a TopProject by NameIdx index key buffer
...
public class CFIntBuffTopProjectByNameIdxKey
	implements ICFIntTopProjectByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFIntBuffTopProjectByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
