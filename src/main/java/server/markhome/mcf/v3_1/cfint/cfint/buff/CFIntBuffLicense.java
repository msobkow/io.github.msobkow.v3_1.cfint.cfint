	...
	implements ICFIntLicense, Comparable<Object>, Serializable
{
	...
	public void setRequiredContainerTopDomain(CFLibDbKeyHash256 argTopDomainId) {
		...
		setRequiredTopDomainId(argTopDomainId);
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerTopDomain-args", "found", found, "ICFIntTopDomainICFIntProtTopDomainICFIntPubTopDomain");
		}
	}
	...
	public void setRequiredContainerTopDomain(CFLibDbKeyHash256 argTopDomainId) {
		...
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerTopDomain-args", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubTopDomainTable targetTable = targetBackingCFInt.getTableTopDomain();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerTopDomain", 0, "ICFIntPubSchema.getBackingCFInt().getTableTopDomain()");
		}
