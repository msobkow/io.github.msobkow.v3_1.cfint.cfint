// Description: Java 25 implementation of a MajorVersion history buffer object
...
public class CFIntBuffMajorVersionH
    implements ICFIntMajorVersionH, Comparable<Object>, Serializable
{
    protected CFIntBuffMajorVersionHPKey pkey;
    ...
    public CFIntBuffMajorVersionH() {
            ...
            pkey = new CFIntBuffMajorVersionHPKey();
    ...
    public void setPKey( ICFIntMajorVersionHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFIntBuffMajorVersionHPKey) {
                this.pkey = (CFIntBuffMajorVersionHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFIntBuffMajorVersionHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFIntBuffMajorVersionH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
