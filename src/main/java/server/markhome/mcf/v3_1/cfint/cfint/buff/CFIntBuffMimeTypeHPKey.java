// Description: Java 25 implementation of a MimeType history buffer primary key
...
/**
 *	CFIntBuffMimeTypeHPKey History Primary Key for MimeType
 *		requiredMimeTypeId	Required object attribute MimeTypeId.
 */
public class CFIntBuffMimeTypeHPKey
	implements ICFIntMimeTypeHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFIntBuffMimeTypeHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
